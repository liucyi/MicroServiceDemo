...
namespace MicroService.Api2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("MicroService.Api2", new Info { Title = "基础数据服务", Version = "v1" });
                var basePath = PlatformServices.Default.Application.ApplicationBasePath;
                var xmlPath = Path.Combine(basePath, "MicroService.Api2.xml");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
        {
            ...
            app.UseSwaggerUI(s => 
            {
                ...
                s.SwaggerEndpoint("/doc/MicroService.Api2/swagger.json", "MicroService.Api2");
            });
            #endregion
        }
